                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-container">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="/design-comuni-prototipi/esempi/bootstrap-italia/template-homepage.html">Home</a><span
        ...
        <section id="intro" class="container px-4 my-4">
            <div class="row">
                <div class="col-lg-7 px-lg-4 py-lg-2">
                    <h1>Novità</h1>
                    <p>Donec in consequat nunc. Duis semper fermentum lacus, ac condimentum justo auctor a. Nam erat
                        erat, porta vel pharetra in, ullamcorper vel turpis.</p>
                ...
                <div class="col-lg-4 offset-lg-1 pt-5 pt-lg-2">
                    <div class="link-list-wrapper">
                        <ul class="link-list">
                            ...
                            <li>
                                <a class="list-item" href="#">Notizie</a>
                            </li>
                            <li>
                                <a class="list-item" href="#">Comunicati</a>
                            </li>
                            <li>
                                <a class="list-item" href="#">Eventi</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <article class="card-wrapper card-space">
                                <div class="card card-bg card-img rounded shadow">
                                    <div class="img-responsive-wrapper">
                                        <div class="img-responsive img-responsive-panoramic">
                                            <figure class="img-wrapper">
                                                <img src="https://via.placeholder.com/310x94/0066cc/FFFFFF/?text=IMMAGINE%20DI%20ESEMPIO"
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">363^ Festa di Sant'Efisio</h5>
                                        <p class="card-text">Il 1° maggio 2019 Cagliari e tutta la Sardegna festeggiano
                                            la 363ª Festa di Sant'Efisio. Un intenso momento di devozione, fede, cultura
                                            e tradizioni centenarie che si fondono in una processione che non ha
                                            eguali.</p>
                                        <a class="read-more"
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <article class="card-wrapper card-space">
                                <div class="card card-bg card-big rounded shadow">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Osservatorio sul turismo</h5>
                            ...
                            <article class="card-wrapper card-space">
                                <div class="card card-bg card-img rounded shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Una breve descrizione della sagra e dei suoi momenti
                                            salienti.</p>
                ...
                <div class="container px-4">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <a href="#"><span class="chip chip-simple chip-primary"><span
                                    class="chip-label">Cultura</span></span></a>
                            <a href="#"><span class="chip chip-simple chip-primary"><span
                                    class="chip-label">Muoversi</span></span></a>
