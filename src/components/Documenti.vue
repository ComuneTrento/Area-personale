              ...
              <svg class="icon icon-sm"><use xlink:href="../assets/dist/svg/sprite.svg#it-search"></use></svg>
                ...
                <div class="col-lg-4 offset-lg-1 pt-5 pt-lg-2">
                    <div class="link-list-wrapper">
                        <ul class="link-list">
                            <li><h3 id="heading-senza-link">Tutti i documenti</h3></li>
                            <li><a class="list-item" href="#">Documenti albo pretorio</a></li>
                            <li><a class="list-item" href="#">Modulistica</a></li>
                            <li><a class="list-item" href="#">Documenti funzionamento interno</a></li>
                            <li><a class="list-item" href="#">Normative</a></li>
                            <li><a class="list-item" href="#">Accordi tra enti</a></li>
                            <li><a class="list-item" href="#">Documenti attività politica</a></li>
                            <li><a class="list-item" href="#">Rapporti (tecnici)</a></li>
                            <li><a class="list-item" href="#">Dataset</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <article class="card-wrapper card-space">
                                <div class="card card-bg card-big rounded shadow">
                                    ...
                                    <div class="etichetta">
                                        <svg class="icon">
                                            <use xlink:href="../assets/dist/svg/sprite.svg#it-files"></use>
                                        </svg>
                                        <span>Atti</span>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <article class="card-wrapper card-space">
                                <div class="card card-bg card-big rounded shadow">
                                    ...
                                    <div class="etichetta">
                                        <svg class="icon">
                                            <use xlink:href="../assets/dist/svg/sprite.svg#it-presentation"></use>
                                        </svg>
                                        <span>Dati</span>
                                    </div>
                                    <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <div class="card-wrapper">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title big-heading">Dati</h5>
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        <a class="read-more" href="#">
                                            <span class="text">Leggi di più</span>
