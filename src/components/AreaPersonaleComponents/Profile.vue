              ...
              <div class="tab-pane p-3 fade show active" id="nav-vertical-tab-ico1" role="tabpanel"
                ...
                <div v-if="userData">
                  ...
                  <div>
                    ...
                    <div class="row">
                      <span class="d-block col-6"><b>{{ $t('area_personale.profilo.codice_fiscale') }}</b></span><span
                  ...
                  <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-1">
                    <div v-for="(familyMember, index) in familyList" v-bind:key="index"
                      ...
                      <div class="card-body pb-5">
                        ...
                        <div class="card-text">
                          <div><p>{{ $t('area_personale.profilo.nato_il') }} {{ familyMember.datanascita }}
                ...
                <div v-else>
                  ...
                  <div v-if="icefData">
                    <div>
                      ...
                      <div class="row">
                        <span class="d-block col-6"><b>{{ $t('area-perosonale.profilo.richiedente') }}</b></span><span
