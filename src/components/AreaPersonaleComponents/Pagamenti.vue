                            ...
                            <div class="table-responsive my-5 shadow" id="payments_table">
                                <table class="table mb-0 bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" @click="sort('SCADENZA')"><span>{{$t('area_personale.pagamenti.scadenza')}}</span>
                                        </th>
                    ...
                    <div v-else>
                        ...
                        <div v-if="payments">
                            <div class="mb-4 float-right bootstrap-select-wrapper">
                                ...
                                <select title="Ordina risultati" @change="sort($event.target.value)" class="p-1 mt-2 border-0 shadow">
                                    <option value="STATO PAGAMENTO">{{$t('area_personale.pagamenti.stato_pagamento')}}</option>
                            ...
                            <table id="payments_table" class="table border-bottom table-white shadow">
                                <tbody>
                                <div v-for="(payment, index) in sortedPayments" v-bind:key="index">
                                    ...
                                    <tr class="row collapse px-4" :id="'payment' + index">
                                        <table id="folders_table" class="table">
                                            ...
                                            <tr>
                                                <td><strong>{{$t('area_personale.pagamenti.stato_pagamento')}}</strong></td>
                            ...
                            <div class="text-center mt-4">
                                <div class="page-item" @click="showMore($event)">
                                    <a href="#">
                                        <span>{{$t('area_personale.pagamenti.show_more', {num_results: this.pageSize, tot_results:this.payments.length})}}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
