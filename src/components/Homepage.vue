<template>
    <main style="padding-top: 0px;">
                    ...
                    <div class="row row-calendar">
                        <div class="it-carousel-wrapper it-carousel-landscape-abstract-three-cols it-calendar-wrapper">
                            ...
                            <div class="it-carousel-all owl-carousel it-card-bg owl-loaded owl-drag">
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 3248px; padding-left: 40px; padding-right: 40px;"><div class="owl-item active" style="width: 352px;"><div class="it-single-slide-wrapper">
                                ...
                                </div></div><div class="owl-item" style="width: 352px;"><div class="it-single-slide-wrapper">
                                    <div class="card-wrapper">
                                        <div class="card card-bg">
                                            <div class="card-body">
                                ...
                                </div></div></div></div><div class="owl-nav disabled"><button class="owl-prev"></button><button class="owl-next"></button></div><div class="owl-dots"><button role="button" class="owl-dot active" aria-labelledby="owl-dot-0"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-1"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-2"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-3"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-4"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-5"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-6"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-7"><span></span></button><button role="button" class="owl-dot" aria-labelledby="owl-dot-8"><span></span></button></div></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="novita">
            <div class="section section-background-header" style="background-image: url(https://picsum.photos/1200/400)">
                <div class="container">
                    <div class="row">
                            ...
                            <form>
                                <div class="form-group mb-1">
                                    <div class="input-group">
                                        ...
                                        <label for="exampleInputText" style="width: auto;">Cerca servizi, informazioni, persone</label>
                                    </div>
                                </div>
                            </form>
