                ...
                <div class="container px-4">
                    ...
                    <div class="row">
                        <div v-for="(service, index) in services" v-bind:key="index" class="col-12 col-sm-6 col-lg-4">
                            <!--start card-->
                            <article v-if="(index / 6) < currentPage && (index / 6) >= currentPage -1" class="card-wrapper card-space">
                        ...
                        <nav class="pagination-wrapper justify-content-center" aria-label="Esempio di paginazione">
                            <ul class="pagination">
                                ...
                                <li v-for="index in this.getPages()" :key="index" class="page-item">
                                    <a v-if="currentPage === index" class="page-link" href="#" aria-current="page" @click="changePage(index, $event)">
                                        <span class="d-inline-block d-sm-none">Pagina </span>{{index}}
                                    </a>
                                <a v-else class="page-link" href="#" @click="changePage(index, $event)">{{index}}</a>
                                </li>
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1" aria-hidden="true">
